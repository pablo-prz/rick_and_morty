...
const rootReducer = (state = initialState, {type, payload}) => {
    switch(type) {
        case ADD_FAV:
            return{
                ...state, 
                myFavorites:[...state.allCharactersF, payload],
                allCharactersF:[...state.allCharactersF, payload]
            };
        case REMOVE_FAV:
            return{
                ...state,
        ...
        case FILTER:
            const allCharactersFiltered = state.allCharactersF.filter(char=>char.gender ===payload)
            return{
                ...state, 
                myFavorites:
